...
public class DataTableParameter {
	...
	public DataTableParameter(int sEcho, int iDisplayStart, int iDisplayLength,
			int iColumns, List<String> mDataProps, List<Boolean> bSortables,
			int iSortingCols, List<Integer> iSortCols,
			List<String> iSortColsName, List<String> sSortDirs) {
		super();
		this.sEcho = sEcho;
