			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" id="name" name="name"
						...
						datatype="*" nullmsg="角色名不能为空">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl">
				<label class="form-label col-3"><span class="c-red">*</span>角色标识：</label>
				<div class="formControls col-5">
					<input type="text" id="identity" name="identity"
						value="${obj.identity}" class="input-text" placeholder=""
						datatype="*" nullmsg="角色标识不能为空">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" id="description" name="description"
						value="${obj.description}" class="input-text" placeholder=""
						datatype="*">
				</div>
				<div class="col-4"></div>
			</div>
