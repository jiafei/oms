		...
		<form action="${ctxPortal}/add" method="post"
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" id="parentName" name="parentName"
						value="${parentObj.name}" class="input-text" placeholder="" readonly="readonly">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-5 skin-minimal">
					<div class="radio-box">
						<input type="radio" id="isMenu-1" name="isMenu" value="1" <c:if test="${obj.isMenu}">checked="checked"</c:if> datatype="*" nullmsg="资源标识不能为空">
						<label for="isMenu-1">是</label>
					</div>
					<div class="radio-box">
						<input type="radio" id="isMenu-0" name="isMenu" value="0" <c:if test="${not obj.isMenu}">checked="checked"</c:if>>
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" id="weight" name="weight"
						value="${obj.weight}" class="input-text" placeholder=""
						datatype="n">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" id="url" name="url"
						value="${obj.url}" class="input-text" placeholder="">
				</div>
				<div class="col-4"></div>
			</div>
			<c:if test="${obj.editable}">
				<div class="row cl">
		...
		$(function() {
			...
			$("#form-add").Validform({
				...
				callback : function(form) {
					$.post("${ctxPortal}/edit", form.serialize(), function(data) {
