...
<body>
	<div class="pd-20">
		<form action="${ctxPortal}/infoEdit" method="post"
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" id="username" name="username"
						value="${user.username}" class="input-text" placeholder=""
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="password" id="newpassword" name="newpassword"
						value="${user.password}" placeholder="密码" autocomplete="off"
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="password" id="password" name="password"
						value="${user.password}" placeholder="确认新密码" autocomplete="off"
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" id="mobilePhone" name="mobilePhone"
						value="${user.mobilePhone}" class="input-text" placeholder=""
		...
		$(function() {
			...
			$("#form-add").Validform({
				...
				callback : function(form) {
					$.post("${ctxPortal}/infoEdit", form.serialize(), function(data) {
						if(data && data.success) {
							parent.$("#table-list").DataTable().ajax.reload();
							var index = parent.layer.getFrameIndex(window.name);
							parent.layer.msg("编辑用户基本信息成功！", {
								icon : 1,
								time : 1000
							});
