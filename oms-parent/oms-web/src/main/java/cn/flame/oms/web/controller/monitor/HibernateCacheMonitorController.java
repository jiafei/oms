...
public class HibernateCacheMonitorController extends UIController {
	...
	public void secondLevelCache(Model model) {
		setMemoryInfo(model);
	}
	...
	public void entityAndCollectionCRUDCount() {
	}
	...
	@RequestMapping("evictCollection")
	@ResponseBody
